...
void Bureaucrat::executeForm(const Form &form) {
    ...
    {
        std::cout << this->_name << " cannot execute " << form.get_name() << " because it is not signed" << std::endl;
        return;
    }
    try
    {
    ...
    {
        std::cerr << this->_name << " cannot execute " << form.get_name() << " because "<< e.what() << std::endl;
    }
}
